...
namespace ClinicaFrba.DataAccess
{
    ...
    public partial class Entities : DbContext
    {
        ...
        public virtual IQueryable<FechasDisponibles_Result> FechasDisponibles(Nullable<int> profesionalId, Nullable<int> especialidadId, Nullable<int> anio)
        {
            var profesionalIdParameter = profesionalId.HasValue ?
                new ObjectParameter("profesionalId", profesionalId) :
                new ObjectParameter("profesionalId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<FechasDisponibles_Result>("[Entities].[FechasDisponibles](@profesionalId, @especialidadId, @anio)", profesionalIdParameter, especialidadIdParameter, anioParameter);
        }
        ...
        public virtual ObjectResult<CompraBono_Result> CompraBono(Nullable<int> afiliadoId, Nullable<int> cant, Nullable<int> planMedicoId, Nullable<System.DateTime> fecha)
        {
            var afiliadoIdParameter = afiliadoId.HasValue ?
                new ObjectParameter("afiliadoId", afiliadoId) :
                new ObjectParameter("afiliadoId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<CompraBono_Result>("CompraBono", afiliadoIdParameter, cantParameter, planMedicoIdParameter, fechaParameter);
        }
